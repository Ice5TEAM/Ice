...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1873723582,115872761}
...
if result.sender_user_id_ == tonumber(1158727611100) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
Text = [[
*𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚* [𝙡𝙖𝙧𝙞𝙘𝙖 𝙩𝙚𝙖𝙢 †](t.me/ice53)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙘𝙝𝙖𝙣𝙣𝙚𝙡',url="https://t.me/ice53"},
},
{
...
inline = {
{{text = '• Ice 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/ice53'}},
}
