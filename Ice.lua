...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Ice Team .',url="t.me/IceTeam "}},
}
local msg_id = msg.id_/2097152/0.5
...
Text = [[
*𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚* [𝙡𝙖𝙧𝙞𝙘𝙖 𝙩𝙚𝙖𝙢 †](t.me/IceTeam)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙨𝙤𝙪𝙧𝙘𝙚 𝙘𝙝𝙖𝙣𝙣𝙚𝙡',url="https://t.me/IceTeam"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/IceTeam&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
inline = {
{{text = '• Ice 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/IceTeam'}},
}
